...
public class Ruay_SupplierAddForm extends JDialog implements ActionListener {
	...
	public Ruay_SupplierAddForm(JFrame frame,int lastidx) {
	    super(frame, true);
	 ...
	 public void actionPerformed(ActionEvent evt) {
	     ...
	     if (actionCommand.equals(addString)) {
	         ...
	         try {
				...
				Ruay_AllLogic.InsertSupplier(lastidx,Sup_Name_txt.getText(),Sup_Address_txt.getText(),Sup_Phone_txt.getText(),Sup_Email_txt.getText());
				
	             // Insert the goods transaction into the database
	             //CSTransacDAO.InsertGoods(NewGoods);
				
	             // Clear the input fields
	             Sup_Name_txt.setText(null);
	             Sup_Address_txt.setText(null);
	             Sup_Phone_txt.setText(null);
	             Sup_Email_txt.setText(null);
	             setVisible(false);
