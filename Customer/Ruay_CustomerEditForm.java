...
public class Ruay_CustomerEditForm extends JDialog implements ActionListener {
	...
	Ruay_Customer Customer;

	private static final String addString = "Update";
	private static final String cancelString = "Cancel";

	public Ruay_CustomerEditForm(JFrame frame,Ruay_Customer Customer) {
		super(frame, true);
		...
		pane.setLayout(null);
		 ...
		 JLabel PerfromLabel = new JLabel("Edit Customer");
		    ...
		    ////////////GET Text////////////////
		    Sup_Name_txt.setText(Customer.getCustomerName());
		    Sup_Name_txt.setFont(new Font("Tahoma", Font.PLAIN, 14));
		    Sup_Address_txt.setText(Customer.getCustomerAddress());
		    Sup_Phone_txt.setText(Customer.getCustomerPhone());
		    Sup_Email_txt.setText(Customer.getCustomerEmail());
		    // Create buttons
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (actionCommand.equals(addString)) {
			...
			Ruay_Supplier NewSup = new Ruay_Supplier(Customer.getCustomerID(),Sup_Name_txt.getText(),Sup_Address_txt.getText(),Sup_Phone_txt.getText(),Sup_Email_txt.getText());
			//System.out.println("New: "+ NewGoods);
			if (NewSup.getSupplierName().equals(Customer.getCustomerName()) &&
					NewSup.getSupplierAddress().equals(Customer.getCustomerAddress())  &&  // Use == for double comparison
					NewSup.getSupplierPhone().equals(Customer.getCustomerPhone()) &&          // Use == for int comparison
					NewSup.getSupplierEmail().equals(Customer.getCustomerEmail())) {
				    System.out.println("Nothing Change!");
				} else {
				    System.out.println("Something Change");
				    Ruay_AllLogic.UpdateCustomer(Customer.getCustomerID(),Sup_Name_txt.getText(),Sup_Address_txt.getText(),Sup_Phone_txt.getText(),Sup_Email_txt.getText());
