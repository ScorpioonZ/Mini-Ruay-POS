package RuayRuayMain.Transaction_form;
...
public class Ruay_TranEditForm extends JDialog implements ActionListener {
	...
	public Ruay_TranEditForm(JFrame frame,Ruay_GoodsType GoodType) {
		super(frame, true);
